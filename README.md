...
A lightweight, parameterised Synchronous FIFO (First-In, First-Out) memory controller written in Verilog.
📥 Key Features
...
Reset: Clears all pointers.
Fill: Writes data until the Full flag triggers.
Empty: Reads data back until the Empty flag triggers.
Validate: Ensures the first value written is the first value read.
🤝 Contributing
